export declare const readUleb128: (buffer: ArrayLike<number>) => {
    value: number;
    length: number;
};
export declare const readUleb128_33: (buffer: ArrayLike<number>) => {
    value: number;
    length: number;
    isMark: number;
};
...
declare const _default: {
    ...
    readUleb128: (buffer: ArrayLike<number>) => {
        value: number;
        length: number;
    };
    readUleb128_33: (buffer: ArrayLike<number>) => {
        value: number;
        length: number;
        isMark: number;
    };
